...
const RemoveMate = props => {
  return (
    <Modal modalId="remove-mate-modal" title="Tem certeza disso!?" onClose={props.onClose}>
        ...
        <button className="btn btn-secondary mr-1" onClick={() => props.removeMate(props.uid, props.mateUid)} data-toggle="modal" data-target="#remove-mate-modal">Sim, desejo remover</button>
