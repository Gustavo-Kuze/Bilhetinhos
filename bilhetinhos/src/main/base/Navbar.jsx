                ...
                <div className="collapse navbar-collapse mx-3" id="navbarCollapse">
                    <ul className="navbar-nav mr-auto text-center">
                        <li className="nav-item active">
                            <a className="nav-link btn btn-lg btn-primary" href="#">Criar bilhete <span className=""><i className="fas fa-plus"></i></span></a>
                        </li>
                    ...
                    <a id="popover-notification" tabIndex="0" className="nav-link btn btn-lg btn-primary" href="#" role="button" data-toggle="popover" data-placement="bottom" data-trigger="focus" title="Notificações" ><i className="far fa-bell"><span className="badge badge-primary badge-pill">2</span></i></a>
